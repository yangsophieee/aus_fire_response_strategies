...
layout <- "AABB\n#CC#"
frac_woody_resprouters + frac_herbaceous_resprouters +
  num_fires_plot + plot_layout(design = layout, widths = c(1, 2, 2, 1))

( frac_woody_resprouters + frac_herbaceous_resprouters + plot_layout(guides = "collect"))
