...
m1 <- glm(
  resprouting_binomial ~
    log10(mean_fires) + I(log10(mean_fires)^2) + log10(mean_fires):woody_or_herb +
    I(log10(mean_fires)^2):woody_or_herb + woody_or_herb,
...
ggpredict(m1, c("mean_fires", "woody_or_herb")) %>%
