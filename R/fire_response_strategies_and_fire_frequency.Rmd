...
write_csv(df_woody_herb_only, "outputs/final_df_predicted_fris_and_fire_response.csv")
df_woody_herb_only <- read_csv("outputs/final_df_predicted_fris_and_fire_response.csv")
```
