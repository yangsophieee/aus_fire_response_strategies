...
ggsave("figures/fire_response_probabilities_phyloglm.png", height = 4.25, width = 9)
```
...
median_fires_per_century <- median_fris %>%
  mutate(across(
    c(med_w, med_w_lwr, med_w_upr, med_wo, med_wo_lwr, med_wo_upr),
    ~ 100 / .x
  )) |>
...
```{r}
hist(median_fires_per_century$med_w)
```
