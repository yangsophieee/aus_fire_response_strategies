...
frac_woody_resprouters <-
  ...
  theme(
    ...
    plot.subtitle = element_text(hjust = 0.55, size = 14),
    axis.title = element_blank(),
    axis.text = element_text(size = 10, colour = "#1a1a1a"),
...
```{r}
resprouting_seeding |> filter(taxon_rank == "species") |> pull(taxon_name) |> unique() |> length()
```
...
species_diversity |> pull(canonical_name) |> unique() |> length()
```
